        ...
        return (
          <button
            ...
            className={`
              ...
              border-2
              ${isSelected ? 'border-[#C8956C]' : 'border-transparent hover:border-[#C8956C]/50'}
            `}
          >
            <div className="w-8 h-8 sm:w-10 sm:h-10 text-[#C8956C] mb-1 sm:mb-2 transition-transform duration-300 group-hover:scale-110">
              {icon}
            </div>
